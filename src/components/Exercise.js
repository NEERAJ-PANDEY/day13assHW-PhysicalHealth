...
const Exercise = () => {
  ...
  return (
    <div className="container mx-auto p-4">
      <h1 className="text-4xl font-semibold mb-4 text-cyan-800">Exercise List</h1>
      
      <ExerciseSearch onSearch={handleSearch} />

      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 bg-red-300">
      ...
      {numCards < (searchResults.length > 0 ? searchResults : exercises).length && (
        <div className="mt-4">
          <button
            ...
            className="bg-red-800 text-white px-4 py-2 rounded-lg hover:bg-blue-600"
          >
            Load More
          </button>
        </div>
