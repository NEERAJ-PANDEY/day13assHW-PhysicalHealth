...
const Banner = () => {
  ...
  <div class="container px-5 py-24 mx-auto flex flex-wrap">
    <div class="flex w-full mb-20 flex-wrap">
      <h1 class="sm:text-3xl text-3xl font-medium title-font text-cyan-900 lg:w-1/3 lg:mb-0 mb-4">Where Fitness Meets Fun and Results Are Achieved</h1>
      <p class="text-red-800 lg:pl-6 lg:w-2/3 mx-auto leading-relaxed text-base">Include an inspiring image or video that showcases your gym's energetic atmosphere, trainers, or members working out.</p>
    </div>
